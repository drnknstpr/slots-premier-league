...
const PREMIER_LEAGUE_CLUBS = [
    ...
    { id: 'aston', name: 'Астон Вилла', hp: 1400 },
    { id: 'bournemouth', name: 'Борнмут', hp: 1950 },
    { id: 'brentford', name: 'Брентфорд', hp: 1050 },
    { id: 'brighton', name: 'Брайтон', hp: 1150 },
    { id: 'burnley', name: 'Бернли', hp: 400 },
    { id: 'chelsea', name: 'Челси', hp: 2300 },
    { id: 'crystal', name: 'Кристал Пэлас', hp: 2100 },
    { id: 'everton', name: 'Эвертон', hp: 950 },
    { id: 'fulham', name: 'Фулхэм', hp: 900 },
    { id: 'leeds', name: 'Лидс Юнайтед', hp: 800 },
    { id: 'liverpool', name: 'Ливерпуль', hp: 2600 },
    { id: 'mancity', name: 'Манчестер Сити', hp: 2450 },
    { id: 'manutd', name: 'Манчестер Юнайтед', hp: 1500 },
    { id: 'newcastle', name: 'Ньюкасл Юнайтед', hp: 1650 },
    { id: 'nottingham', name: 'Ноттингем Форест', hp: 600 },
    { id: 'sunderland', name: 'Сандерленд', hp: 1250 },
    { id: 'tottenham', name: 'Тоттенхэм', hp: 1800 },
    { id: 'westham', name: 'Вест Хэм', hp: 700 },
    { id: 'wolves', name: 'Вулверхэмптон', hp: 500 }
];
